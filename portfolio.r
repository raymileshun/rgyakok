##Órai feladat, mondta hogy ilyen lehet zhban. Lineáris regressziót kell
##csinálni.
##Oldalán a Stat II. oldalon az uj_feladatsor a 49.-es példát
##csináltuk. (a parancsokat kommentezni is kell, ez az úgymond
## "magyarázás")
...
y_hat<-b0+b1*x;y_hat #becsült élettartam
lines(x,y_hat,col="blue")
b0+b1*12 #12 iskolai évesnek a becsült élettartama
...
x<-c(12.6,12.4,11.6,10.4,4.4) #tanulás
y<-c(81.1,78.5,75.4,74,65.4)  #várható élettartam
lm(y~x) #Intercept:  x=0-hoz tartozó y érték, azaz ha valaki
...
predict(lm(y~x), newdata=data.frame(x=12)) #Azaz 12 éves iskolázattsági
					  #szintnél annyi a várható élettartam (77.79)
